	...
	e.fn.marquee = function(t) {
		return this.each(function() {
			...
			var A = function() {
				...
				O = function() {
					i.css("margin-right", n.direction == "right" ? s + "px" : "-" + a + "px")
				};
			if (n.duplicated) {
				if (u) {
					i.css("margin-top", n.direction == "up" ? b : "-" + (w * 2 - n.gap) + "px")
				} else {
					i.css("margin-right", n.direction == "right" ? s + "px" : "-" + (a * 2 - n.gap) + "px")
				}
				f = 1
			} else {
				if (u) {
			...
			var M = function() {
				if (n.duplicated) {
					if (f === 1) {
						...
						if (u) {
							...
							n.duration = n.direction == "right" ? n.duration + s / (a / n.duration) : n.duration * 2
						}
						if (N) {
				...
				if (u) {
					...
					if (n.duplicated) {
						if (f > 2) {
							i.css("margin-right", n.direction == "right" ? 0 : "-" + a + "px")
						}
						o = {
							"margin-right": n.direction == "right" ? "-" + a + "px" : 0
						}
					} else {
						O();
						o = {
							"margin-right": n.direction == "right" ? "-" + a + "px" : s + "px"
						}
					}
				}
...
/*
     ...
     INTERNET ARCHIVE ON 10:20:04 Mar 11, 2025.
...
playback timings (ms):
  ...
  esindex: 0.01
  cdx.remote: 17.849
  LoadShardBlock: 232.278 (3)
  PetaboxLoader3.datanode: 1833.186 (4)
  PetaboxLoader3.resolve: 377.604 (2)
  load_resource: 2030.514
*/